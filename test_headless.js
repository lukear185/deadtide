...
function checkGacha(){
 ...
 if(HEROES.length!==27){console.log('FAIL: 英雄が27種でない '+HEROES.length);process.exit(1);}/* 🐉(252)炎龍ウグニウス */
 ...
 const want={1:5,2:4,3:4,4:4,5:10};/* 💧(254)クループで★5は10人 *//* 🌌(254)ディメンションナイトで★5は9人 *//* 🐉(252)炎龍ウグニウスで★5は8人 */
